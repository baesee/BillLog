...
jui.define("chart.theme.jennifer", [], function() {
    ...
    return {
    	...
    	gridActiveFontColor : "#FFFFFF",
        gridActiveBorderColor : "#FFFFFF",
        ...
        waterfallInvertBackgroundColor : "#FFFFFF",
...
jui.define("chart.theme.gradient", [], function() {
    ...
    return {
        ...
        waterfallInvertBackgroundColor : "linear(top) #ff9d46,0.9 #FFFFFF",
